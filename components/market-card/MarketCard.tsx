...
export const MarketCard: React.FC<IMarketCardProps> = ({ market }) => {
  return (
    <div className='flex flex-col border border-zinc-700 rounded-2xl bg-zinc-700 p-4 w-max min-w-max xs:min-w-fit xs:w-full'>
      ...
      <div className='flex flex-row gap-x-3'>
          ...
          <div className='flex flex-col flex-1 xs:w-full'>
